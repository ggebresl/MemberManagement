        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Street_Addres = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Member_Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    US_Arrival_Date = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Member_Start_Date = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Member_End_Date = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Payment_Reason = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsMember = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_payment", x => x.PaymentID);
                    table.ForeignKey(
                        name: "FK_payment_userlogin_LoginID",
                        column: x => x.LoginID,
